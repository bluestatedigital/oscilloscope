...
var HystrixThreadPoolAggregator = function() {
  var state = {
    type: Configuration.HystrixThreadPoolType,
    values: {},
    sorting: new Sorting()
  }
  ...
  return {
    ...
    preprocess: function(value) {
      ...
      var totalThreadsExecuted = value.rollingCountThreadsExecuted
      ...
      var ratePerSecondPerHost =  Utility.getRoundedNumber(totalThreadsExecuted / numberSeconds / value.reportingHosts)
...
module.exports = HystrixThreadPoolAggregator
